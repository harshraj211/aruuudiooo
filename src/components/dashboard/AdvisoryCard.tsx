...
const cropOptions = [
    ...
    { value: 'Arhar (Tur / Pigeon Pea)', label: 'Arhar (Tur / Pigeon Pea)' },
...
const fruitOptions = [
    ...
    { value: 'Sweet Lime (Mosambi)', label: 'Sweet Lime (Mosambi)' },
    { value: 'Mandarin', label: 'Mandarin' },
    { value: 'Lemon', label: 'Lemon' },
    { value: 'Sapota (Chikoo)', label: 'Sapota (Chikoo)' },
    { value: 'Jamun (Black Plum)', label: 'Jamun (Black Plum)' },
    { value: 'Custard Apple (Sitaphal)', label: 'Custard Apple (Sitaphal)' },
    { value: 'Fig', label: 'Fig' },
    { value: 'Ber (Indian Jujube)', label: 'Ber (Indian Jujube)' },
    ...
    { value: 'Muskmelon (Cantaloupe)', label: 'Muskmelon (Cantaloupe)' },
    { value: 'Starfruit (Carambola)', label: 'Starfruit (Carambola)' },
    { value: 'Bael (Wood Apple)', label: 'Bael (Wood Apple)' },
    { value: 'Phalsa', label: 'Phalsa' },
    { value: 'Karonda', label: 'Karonda' },
